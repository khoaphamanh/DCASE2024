...
#SBATCH --job-name=dcase24     # Name unter dem der Job in der Job-History gespeichert wird
#SBATCH --output=dcase24-%j.txt   # Logdatei für den merged STDOUT/STDERR output (%j wird durch slurm job-ID ersetzt)
