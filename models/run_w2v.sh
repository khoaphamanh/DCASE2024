...
#SBATCH --job-name=khoa_test_slurm      # Name unter dem der Job in der Job-History gespeichert wird
...
#SBATCH --time=00:10:00             # Maximale Laufzeit des Jobs, bis Slurm diesen abbricht (HH:MM:SS)
...
#SBATCH --mem=16G                   # Reservierung von 10GB RAM
#SBATCH --gres=gpu:1
