...
#SBATCH --job-name=new_new_pipeline     # Name unter dem der Job in der Job-History gespeichert wird
#SBATCH --output=/home/phamanh/nobackup/DCASE2024/models/result/a_new_pipeline-%j.txt   # Logdatei für den merged STDOUT/STDERR output (%j wird durch slurm job-ID ersetzt)

#SBATCH --time=99:00:00             # Maximale Laufzeit des Jobs, bis Slurm diesen abbricht (HH:MM:SS)
#SBATCH --partition=gpu_long_stud   # Partition auf der gerechnet werden soll. Ohne Angabe des Parameters wird auf der
...
python /home/phamanh/nobackup/DCASE2024/models/new_new_pipeline.py